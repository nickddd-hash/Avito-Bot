...
## TODO
- [ ] Поменять responseMode на "onReceived" или добавить "Respond to Webhook" ноду (убирает дубли при медленном AI)
- [ ] Убрать потенциальный хардкод user_id (сейчас берётся из webhook — ок)
